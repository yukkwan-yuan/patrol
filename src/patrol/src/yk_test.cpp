...
void nasal_swab::det_callback(detection_msgs::Det3DArray msg)
{
    ...
    {   
        ...
        for(int i=0; i<target_bias.dets_list.size(); i++)
        {
            ...
            br.sendTransform(tf::StampedTransform(tf1, ros::Time::now(), "rs_camera_link", tf_name1 + to_string(i)));
            string b;
...
{  
    ...
    while(1)
    {
        ...
        // {
        //     ROS_INFO("test");
        //     target_pose.orientation.w=0.477182051571;
        //     target_pose.orientation.x=0.487386102031;
        //     target_pose.orientation.y=0.515073527696;
        //     target_pose.orientation.z=0.519087023796;
        //     target_pose.position.x=0.403969734907;
        //     target_pose.position.y=-0.119237922132;
        //     target_pose.position.z=0.585955321789;
        ...
        {   
            ...
            // listener.lookupTransform("/tm_end_eff", "/tm_target_pose", ros::Time(0), tf2);
                    ...
                    current_pose.position.x += (target_bias.dets_list[i].x-0.155);
                    current_pose.position.y += (target_bias.dets_list[i].y + 0.03);
                    current_pose.position.z += (target_bias.dets_list[i].z+0.12);
